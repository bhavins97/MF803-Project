...
print(AtlasOption(0.0184,0,0,1,test_paths_0_vol).get_price())
print("Should see price of the index:", float(latest_prices[-1]))
print(AtlasOption(0.0184,0,0,0,test_paths_0_mat).get_price())
print("Should see:", float(latest_prices[-1]) * np.exp(0.0184))
print(AtlasOption(0.0184,0,0,0,test_paths_0_vol).get_price())
