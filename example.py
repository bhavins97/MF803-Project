...
example_sim = BS_sim(example_init_prices, 0.0184, example_vols, example_corr, 1)
example_paths = example_sim.simulate()
example_option = AtlasOption(0.0184,5,5,1,example_paths)
example_price = example_option.get_price()
